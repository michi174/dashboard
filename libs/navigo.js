    ...
    Navigo.prototype = {
        ...
        navigate: function navigate(path, absolute) {
            ...
            if (this._usePushState) {
                ...
                window.location.href =
                    window.location.href.replace(/#$/, "").replace(new RegExp(this._hash + ".*$"), "") +
                    this._hash +
                    path;
            }
            return this;
        ...
        resolve: function resolve(current) {
            ...
            if (
                ...
                //return false; //TODO: Find out why we have mutliple navigation on the same url.
            }
                        ...
                        manageHooks(
                            function () {
                                m.route.route instanceof RegExp
                                    ? handler.apply(undefined, m.match.slice(1, m.match.length))
        ...
        pause: function pause() {
            ...
            if (status) {
                ...
                console.log("[NAVIGO] pause()");
            } else {
                this._historyAPIUpdateMethod = "pushState";
            }
        },
        resume: function resume() {
            console.log("[NAVIGO] resume()");
            this.pause(false);
        },
